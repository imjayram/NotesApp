  ...
  return (
    <div className='relative'>
        ...
        <div className='flex flex-col gap-2'>
            <label className='input-label text-red-600'>TITLE</label>
            <input type="text"
        ...
        <div className='flex flex-col gap-2 mt-4'>
            <label className='input-label text-red-600'>CONTENT</label>
            <textarea
             type="text"
        ...
        <div className='mt-3'>
            <label className='input-label text-red-600'>TAGS</label>
            <TagInput tags={tags} setTags={setTags}/>
        </div>
        
        {error && <p className='text-red-500 text-xs pt-4'>{error}</p>}

        <button className="button-primary font-medium mt-5 p-3"
